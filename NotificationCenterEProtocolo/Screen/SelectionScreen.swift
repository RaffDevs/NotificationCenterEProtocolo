...
class SelectionScreen: UIView {
    ...
    lazy var macbookButton: UIButton = {
        ...
        button.setImage(UIImage(named: "Macbook"), for: .normal)
    ...
    lazy var imacButton: UIButton = {
        let button = UIButton(type: .system)
        button.translatesAutoresizingMaskIntoConstraints = false
        button.setImage(UIImage(named: "Imac"), for: .normal)
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            imacButton.topAnchor.constraint(equalTo: macbookButton.bottomAnchor, constant: 70),
